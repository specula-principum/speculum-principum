...
def _register_write_tools(registry: ToolRegistry) -> None:
    ...
    registry.register_tool(
        ToolDefinition(
            ...
            description="Register a new source in the registry. Requires approval_issue for derived sources.",
            parameters={
                "type": "object",
                "properties": {
                    "url": {
                    ...
                    "approval_issue": {
                        "type": "integer",
                        "description": "Issue number that approved this source. Required for derived sources.",
                    },
                    "added_by": {
                        "type": "string",
    ...
    registry.register_tool(
        ToolDefinition(
            name="propose_source",
            description="Create a GitHub Issue proposing a new source for approval. Includes credibility assessment.",
            parameters={
                "type": "object",
                "properties": {
                    "url": {
            ...
            handler=_propose_source_handler,
            risk_level=ActionRisk.REVIEW,
        )
    )
    ...
    registry.register_tool(
        ToolDefinition(
            ...
            description="Process /approve-source or /reject-source commands from issue comments.",
            parameters={
                "type": "object",
                "properties": {
                    "issue_number": {
                        "type": "integer",
                        "description": "Issue number containing the source proposal.",
                    },
                    "command": {
                        "type": "string",
                        "enum": ["approve", "reject"],
                        "description": "The approval command to process.",
                    },
                    "comment_author": {
                        "type": "string",
                        "description": "GitHub username of the person who issued the command.",
                    },
                    "rejection_reason": {
                        "type": "string",
                        "description": "Reason for rejection (required if command is 'reject').",
                    },
                    "source_url": {
                        "type": "string",
                        "description": "URL of the source being approved/rejected.",
                    },
                    "source_name": {
                        "type": "string",
                        "description": "Name of the source (for registration).",
                    },
                    "repository": {
                        "type": "string",
                ...
                "required": ["issue_number", "command", "source_url", "source_name"],
                "additionalProperties": False,
            },
            handler=_process_source_approval_handler,
    ...
    registry.register_tool(
        ToolDefinition(
            ...
            description="Sync a source entry to a GitHub Discussion in the Sources category.",
            parameters={
                "type": "object",
                "properties": {
                    "url": {
...
def _register_source_handler(args: Mapping[str, Any]) -> ToolResult:
    ...
    approval_issue = args.get("approval_issue")
    ...
    # Validate: derived sources require approval_issue
    if source_type == "derived" and approval_issue is None:
        return ToolResult(
            success=False,
            output=None,
            error="Derived sources require an approval_issue number.",
        )
...
def _update_source_status_handler(args: Mapping[str, Any]) -> ToolResult:
    ...
    updated = SourceEntry(
        ...
        approval_issue=source.approval_issue,
