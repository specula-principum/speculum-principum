...
Attachments:
- Current phase README (devops/projects/phase-X-*/README.md)
- Current phase PROGRESS log (devops/projects/phase-X-*/PROGRESS.md)
...
Attachments:
- Relevant phase README (devops/projects/phase-X-*/README.md)
- Relevant phase PROGRESS log (devops/projects/phase-X-*/PROGRESS.md)
